...
public:
    double findMedianSortedArrays(vector<int>& nums1, vector<int>& nums2) {
        // Using binary search for this problem is crazy...
        // I used two pointers, and it makes a better asymptotic solution O(n+m), instead of O(log(n+m))
        // And yet it's in-place, do not require extra space.
        size_t idx1 = 0;
        size_t idx2 = 0;
